...
By default, bitpulse Core allows up to 125 connections to different peers, 11 of
...
limits are tiny. Keep in mind that bitpulse's trustless model works best if you are
