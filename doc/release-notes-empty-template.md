...
bitpulsed Core version *version* is now available from:

  <https://bitpulsedcore.org/bin/bitpulsed-core-*version*/>
...
using the Linux Kernel 3.17+, macOS 11.0+, and Windows 7 and newer. bitpulsed
