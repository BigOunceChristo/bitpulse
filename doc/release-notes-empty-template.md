...
bitpulse Core version *version* is now available from:

  <https://bitpulsecore.org/bin/bitpulse-core-*version*/>
...
using the Linux Kernel 3.17+, macOS 11.0+, and Windows 7 and newer. bitpulse
