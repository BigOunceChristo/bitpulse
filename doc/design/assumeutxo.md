...
Assumeutxo is a feature that allows fast bootstrapping of a validating bitpulsed
instance.
...
considered active. This is the "traditional" mode of operation for bitpulsed.
...
### bitpulsed restarts sometime after snapshot validation has completed
