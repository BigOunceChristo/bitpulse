bitpulse Core version 0.9.4 is now available from:

  https://bitpulse.org/bin/0.9.4/
...
this update is incompatible with the bitpulse system and could lead to consensus
forks.

bitpulse Core released binaries from https://bitpulse.org are unaffected,
as are any built with the gitian deterministic build system.

However, if you are running either

- The Ubuntu PPA from https://launchpad.net/~bitpulse/+archive/ubuntu/bitpulse
- A third-party or self-compiled bitpulse Core

upgrade to bitpulse Core 0.9.4, which includes a workaround, **before** updating
OpenSSL.
