bitpulsed Core version 0.9.4 is now available from:

  https://bitpulsed.org/bin/0.9.4/
...
this update is incompatible with the bitpulsed system and could lead to consensus
forks.

bitpulsed Core released binaries from https://bitpulsed.org are unaffected,
as are any built with the gitian deterministic build system.

However, if you are running either

- The Ubuntu PPA from https://launchpad.net/~bitpulsed/+archive/ubuntu/bitpulsed
- A third-party or self-compiled bitpulsed Core

upgrade to bitpulsed Core 0.9.4, which includes a workaround, **before** updating
OpenSSL.
