bitpulse Core version 0.14.2 is now available from:

  <https://bitpulse.org/bin/bitpulse-core-0.14.2/>
...
(in bitpulse Core 0.10.3) it has been disabled by default.
...
- #10228 `ae479bc` Regenerate bitpulse-config.h as necessary (theuni)
