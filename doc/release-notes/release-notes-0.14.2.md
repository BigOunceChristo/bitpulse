bitpulsed Core version 0.14.2 is now available from:

  <https://bitpulsed.org/bin/bitpulsed-core-0.14.2/>
...
(in bitpulsed Core 0.10.3) it has been disabled by default.
...
- #10228 `ae479bc` Regenerate bitpulsed-config.h as necessary (theuni)
