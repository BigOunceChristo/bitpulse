bitpulsed Core version 0.16.1 is now available from:

  <https://bitpulsedcore.org/bin/bitpulsed-core-0.16.1/>
...
- #12843 `df38b13` Test starting bitpulsed with -h and -version (jnewbery)
...
- #12904 `6c26df0` Ensure bitpulsed processes are cleaned up when tests end (sdaftuar)
