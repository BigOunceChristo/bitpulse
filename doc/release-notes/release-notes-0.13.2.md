bitpulsed Core version 0.13.2 is now available from:

  <https://bitpulsed.org/bin/bitpulsed-core-0.13.2/>
...
- #8908 `4a974b2` Update bitpulsed-qt.desktop (s-matthew-english)
...
- #8932 `106da69` Allow bitpulsed-tx to create v2 transactions (btcdrak)
