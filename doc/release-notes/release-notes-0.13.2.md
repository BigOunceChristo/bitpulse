bitpulse Core version 0.13.2 is now available from:

  <https://bitpulse.org/bin/bitpulse-core-0.13.2/>
...
- #8908 `4a974b2` Update bitpulse-qt.desktop (s-matthew-english)
...
- #8932 `106da69` Allow bitpulse-tx to create v2 transactions (btcdrak)
