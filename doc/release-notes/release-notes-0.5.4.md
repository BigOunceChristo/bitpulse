bitpulsed version 0.5.4 is now available for download at:
...
http://gitorious.org/bitpulsed/bitpulsed-stable/archive-tarball/v0.5.4#.tar.gz
...
Fix bitpulsed-Qt notifications under Growl 1.3.
Increase required age of bitpulsed-Qt's "not up to date" status from 30 to 90 minutes.
...
Remove wxbitpulsed properly when installing bitpulsed-Qt over it. (Windows)
