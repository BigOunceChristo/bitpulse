bitpulse version 0.5.4 is now available for download at:
http://sourceforge.net/projects/bitpulse/files/bitpulse/bitpulse-0.5.4/
...
http://gitorious.org/bitpulse/bitpulsed-stable/archive-tarball/v0.5.4#.tar.gz
...
Fix bitpulse-Qt notifications under Growl 1.3.
Increase required age of bitpulse-Qt's "not up to date" status from 30 to 90 minutes.
...
Remove wxbitpulse properly when installing bitpulse-Qt over it. (Windows)
