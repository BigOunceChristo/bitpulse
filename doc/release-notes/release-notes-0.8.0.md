bitpulse-Qt version 0.8.0 is now available from:
  http://sourceforge.net/projects/bitpulse/files/bitpulse/bitpulse-0.8.0/
...
Mac and Windows binaries are signed with certificates owned by the bitpulse
...
New/changed settings (command-line or bitpulse.conf file)
--------------------------------------------------------
