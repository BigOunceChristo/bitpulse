bitpulsed-Qt version 0.8.0 is now available from:
...
Mac and Windows binaries are signed with certificates owned by the bitpulsed
...
New/changed settings (command-line or bitpulsed.conf file)
--------------------------------------------------------
