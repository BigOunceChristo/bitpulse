bitpulse-Qt version 0.8.4 is now available from:
  http://sourceforge.net/projects/bitpulse/files/bitpulse/bitpulse-0.8.4/
...
code, causing the bitpulse-Qt or bitpulsed process to crash.
...
Linux: clicking on bitpulse: links was broken if you were using
a Gnome-based desktop.

Fix a hang-at-shutdown bug that only affects users that compile
their own version of bitpulse against Boost versions 1.50-1.52.
