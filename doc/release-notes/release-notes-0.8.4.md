bitpulsed-Qt version 0.8.4 is now available from:
...
code, causing the bitpulsed-Qt or bitpulsed process to crash.
...
Linux: clicking on bitpulsed: links was broken if you were using
a Gnome-based desktop.

Fix a hang-at-shutdown bug that only affects users that compile
their own version of bitpulsed against Boost versions 1.50-1.52.
