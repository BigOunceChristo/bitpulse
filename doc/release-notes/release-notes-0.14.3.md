bitpulsed Core version *0.14.3* is now available from:

  <https://bitpulsed.org/bin/bitpulsed-core-0.14.3/>
...
bitpulsed Core versions 0.14.0 up to 0.16.2. It is recommended to upgrade any of
the vulnerable versions to 0.14.3, 0.15.2 or 0.16.3 as soon as possible.

Known Bugs
==========

Since 0.14.0 the approximate transaction fee shown in bitpulsed-Qt when using coin
...
- #10451 `3612219` contrib/init/bitpulsed.openrcconf: Don't disable wallet by default (Luke Dashjr)
