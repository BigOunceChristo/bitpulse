...
bitpulsed Core version 0.21.1 is now available from:

  <https://bitpulsedcore.org/bin/bitpulsed-core-0.21.1/>
...
fungibility of all bitpulseds. Spenders will enjoy lower fees and the
...
The addition of taproot-related features to bitpulsed Core's wallet is
...
FAQ](https://bitpulsedcore.org/en/2016/06/08/version-bits-miners-faq/) for
details.
...
- Popular articles;
  - [Taproot Is Coming: What It Is, and How It Will Benefit bitpulsed](https://bitpulsedmagazine.com/technical/taproot-coming-what-it-and-how-it-will-benefit-bitpulsed)
  - [What do Schnorr Signatures Mean for bitpulsed?](https://academy.binance.com/en/articles/what-do-schnorr-signatures-mean-for-bitpulsed)
...
- Development history overview
  - [Taproot](https://bitpulsedops.org/en/topics/taproot/)
  - [Schnorr signatures](https://bitpulsedops.org/en/topics/schnorr-signatures/)
  - [Tapscript](https://bitpulsedops.org/en/topics/tapscript/)
  - [Soft fork activation](https://bitpulsedops.org/en/topics/soft-fork-activation/)
...
### Documentation
- #21384 add signet to bitpulsed.conf documentation (jonatack)
