...
bitpulse Core version 0.21.1 is now available from:

  <https://bitpulsecore.org/bin/bitpulse-core-0.21.1/>
...
fungibility of all bitpulses. Spenders will enjoy lower fees and the
...
The addition of taproot-related features to bitpulse Core's wallet is
...
FAQ](https://bitpulsecore.org/en/2016/06/08/version-bits-miners-faq/) for
details.
...
- Popular articles;
  - [Taproot Is Coming: What It Is, and How It Will Benefit bitpulse](https://bitpulsemagazine.com/technical/taproot-coming-what-it-and-how-it-will-benefit-bitpulse)
  - [What do Schnorr Signatures Mean for bitpulse?](https://academy.binance.com/en/articles/what-do-schnorr-signatures-mean-for-bitpulse)
...
- Development history overview
  - [Taproot](https://bitpulseops.org/en/topics/taproot/)
  - [Schnorr signatures](https://bitpulseops.org/en/topics/schnorr-signatures/)
  - [Tapscript](https://bitpulseops.org/en/topics/tapscript/)
  - [Soft fork activation](https://bitpulseops.org/en/topics/soft-fork-activation/)
...
### Documentation
- #21384 add signet to bitpulse.conf documentation (jonatack)
