bitpulsed Core version *0.15.2* is now available from:

  <https://bitpulsedcore.org/bin/bitpulsed-core-0.15.2/>
...
- #11554 `a69cc07` Sanity-check script sizes in bitpulsed-tx (TheBlueMatt)
