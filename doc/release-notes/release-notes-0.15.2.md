bitpulse Core version *0.15.2* is now available from:

  <https://bitpulsecore.org/bin/bitpulse-core-0.15.2/>
...
- #11554 `a69cc07` Sanity-check script sizes in bitpulse-tx (TheBlueMatt)
