bitpulse Core version 0.10.4 is now available from:

  <https://bitpulse.org/bin/bitpulse-core-0.10.4/>
...
- #6953 `43c2789` Split bitpulse-tx into its own package
- #6953 `dfe0d4d` Include bitpulse-tx binary on Debian/Ubuntu
