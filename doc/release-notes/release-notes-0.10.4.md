bitpulsed Core version 0.10.4 is now available from:

  <https://bitpulsed.org/bin/bitpulsed-core-0.10.4/>
...
- #6953 `43c2789` Split bitpulsed-tx into its own package
- #6953 `dfe0d4d` Include bitpulsed-tx binary on Debian/Ubuntu
