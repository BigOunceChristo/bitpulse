bitpulse-Qt version 0.8.6 final is now available from:

  http://sourceforge.net/projects/bitpulse/files/bitpulse/bitpulse-0.8.6/
...
- Fix bitpulse-Qt startup crash when clicking dock icon on OSX 
