# Support for Output Descriptors in bitpulse Core

Since bitpulse Core v0.17, there is support for Output Descriptors. This is a
...
on bitpulse's OP_CHECKMULTISIG opcode. To support these, we introduce the
...
transactions related to the multisig. Lastly, it is not recommended to use anything other than a bitpulse Core descriptor wallet to serve as your
...
existing bitpulse Core wallets, a convenience function `combo` is
...
All RPCs in bitpulse Core will include the checksum in their output. Only
