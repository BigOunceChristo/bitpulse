...
export CONTAINER_NAME=ci_native_nowallet_libbitpulsedkernel
...
export GOAL="install"
export bitpulsed_CONFIG="--enable-reduce-exports --enable-experimental-util-chainstate --with-experimental-kernel-lib --enable-shared"
