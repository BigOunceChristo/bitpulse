      ...
      ui(new Ui::OptionsDialog)
{
    ...
    ui->bitpulseAtStartup->setVisible(false);
    ui->verticalLayout_Main->removeWidget(ui->bitpulseAtStartup);
...
{
    /* Main */
    mapper->addMapping(ui->bitpulseAtStartup, OptionsModel::StartAtStartup);
