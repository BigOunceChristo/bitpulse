...
#ifndef bitpulse_QT_RECEIVECOINSDIALOG_H
#define bitpulse_QT_RECEIVECOINSDIALOG_H
...
/** Dialog for requesting payment of bitpulses */
...
#endif // bitpulse_QT_RECEIVECOINSDIALOG_H
