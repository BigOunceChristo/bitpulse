...
#ifndef bitpulse_QT_OPTIONSMODEL_H
#define bitpulse_QT_OPTIONSMODEL_H
...
/** Interface from Qt to configuration data structure for Bitpulse client.
...
public:
    ...
    BitpulseUnit getDisplayUnit() const { return m_display_bitpulse_unit; }
...
private:
    ...
    QString language;
    BitpulseUnit m_display_bitpulse_unit;
...
Q_SIGNALS:
    void displayUnitChanged(BitpulseUnit unit);
...
#endif // bitpulse_QT_OPTIONSMODEL_H
