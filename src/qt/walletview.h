...
#ifndef bitpulse_QT_WALLETVIEW_H
#define bitpulse_QT_WALLETVIEW_H
...
private:
    ...
    //!
    //! The wallet model represents a bitpulse wallet, and offers access to
...
#endif // bitpulse_QT_WALLETVIEW_H
