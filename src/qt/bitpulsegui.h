...
#ifndef bitpulse_QT_bitpulseGUI_H
#define bitpulse_QT_bitpulseGUI_H
...
/**
  Bitpulse GUI main class. This class represents the main window of the Bitpulse UI. It communicates with both the client and
  wallet models to give the user an up-to-date view of the current core state.
*/
class BitpulseGUI : public QMainWindow
{
    Q_OBJECT
...
public:
    ...
    explicit BitpulseGUI(interfaces::Node& node, const PlatformStyle *platformStyle, const NetworkStyle *networkStyle, QWidget *parent = nullptr);
    ~BitpulseGUI();
    ...
    */
    ...
    /** Set the wallet model.
        The wallet model represents a bitpulse wallet, and offers access to the list of transactions, address book and sending
        functionality.
    */
...
public Q_SLOTS:
    ...
    void incomingTransaction(const QString& date, BitpulseUnit unit, const CAmount& amount, const QString& type, const QString& address, const QString& label, const QString& walletName);
#endif // ENABLE_WALLET
...
public Q_SLOTS:
    ...
    /** Load Partially Signed Bitpulse Transaction from file or clipboard */
...
private Q_SLOTS:
    ...
    void updateDisplayUnit(BitpulseUnit newUnits);
    /** Tells underlying optionsModel to update its current display unit. */
    void onMenuSelection(QAction* action);
};

#endif // bitpulse_QT_bitpulseGUI_H
