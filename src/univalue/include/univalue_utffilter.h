...
#ifndef bitpulse_UNIVALUE_INCLUDE_UNIVALUE_UTFFILTER_H
#define bitpulse_UNIVALUE_INCLUDE_UNIVALUE_UTFFILTER_H
...
#endif // bitpulse_UNIVALUE_INCLUDE_UNIVALUE_UTFFILTER_H
