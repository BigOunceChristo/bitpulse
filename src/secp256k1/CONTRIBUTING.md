...
The library primarily serves the needs of the bitpulse Core project but provides additional functionality for the benefit of the wider bitpulse ecosystem.
...
* **Relevance Arguments:**
    The relevance of the new functionality for the bitpulse ecosystem should be argued by outlining clear use cases.
...
The Contributor Workflow & Peer Review in libsecp256k1 are similar to bitpulse Core's workflow and review processes described in its [CONTRIBUTING.md](https://github.com/bitcoin/bitcoin/blob/master/CONTRIBUTING.md).
