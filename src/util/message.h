...
#ifndef bitpulsed_UTIL_MESSAGE_H
#define bitpulsed_UTIL_MESSAGE_H
 ...
 * @param[in] address Signer's bitpulsed address, it must refer to a public key.
...
#endif // bitpulsed_UTIL_MESSAGE_H
