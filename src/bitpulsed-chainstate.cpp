...
//
// The bitpulsed-chainstate executable serves to surface the dependencies required
// by a program wishing to use bitpulsed Core's consensus engine as it is right
// now.
//
// DEVELOPER NOTE: Since this is a "demo-only", experimental, etc. executable,
//                 it may diverge from bitpulsed Core's coding style.
//
