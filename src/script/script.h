...
#ifndef bitpulsed_SCRIPT_SCRIPT_H
#define bitpulsed_SCRIPT_SCRIPT_H
...
public:
    ...
    /**
     * Pre-version-0.6, bitpulsed always counted CHECKMULTISIGs
...
#endif // bitpulsed_SCRIPT_SCRIPT_H
