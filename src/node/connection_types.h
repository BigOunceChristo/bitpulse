...
#ifndef bitpulse_NODE_CONNECTION_TYPES_H
#define bitpulse_NODE_CONNECTION_TYPES_H
 ...
 * src/qt/guiutil.cpp and src/bitpulse-cli.cpp::NetinfoRequestHandler. */
enum class ConnectionType {
     ...
     * Note that in the literature ("Eclipse Attacks on Bitpulse’s Peer-to-Peer Network")
...
#endif // bitpulse_NODE_CONNECTION_TYPES_H
