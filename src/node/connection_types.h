...
#ifndef bitpulsed_NODE_CONNECTION_TYPES_H
#define bitpulsed_NODE_CONNECTION_TYPES_H
 ...
 * src/qt/guiutil.cpp and src/bitpulsed-cli.cpp::NetinfoRequestHandler. */
enum class ConnectionType {
     ...
     * Note that in the literature ("Eclipse Attacks on bitpulsed’s Peer-to-Peer Network")
...
#endif // bitpulsed_NODE_CONNECTION_TYPES_H
