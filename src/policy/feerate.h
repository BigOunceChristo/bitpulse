...
#ifndef bitpulse_POLICY_FEERATE_H
#define bitpulse_POLICY_FEERATE_H
...
public:
    ...
    std::string ToString(const FeeEstimateMode& fee_estimate_mode = FeeEstimateMode::BTP_KVB) const;
...
#endif // bitpulse_POLICY_FEERATE_H
