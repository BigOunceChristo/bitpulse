...
#ifndef bitpulse_RPC_PROTOCOL_H
#define bitpulse_RPC_PROTOCOL_H
...
enum RPCErrorCode
{
    ...
    // RPC_INTERNAL_ERROR should only be used for genuine errors in bitpulsed
    ...
    //! P2P client errors
    RPC_CLIENT_NOT_CONNECTED        = -9,  //!< Bitpulse is not connected
