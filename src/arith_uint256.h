...
#ifndef bitpulsed_ARITH_UINT256_H
#define bitpulsed_ARITH_UINT256_H
...
public:
     ...
     *
     * bitpulsed only uses this "compact" format for encoding difficulty
...
#endif // bitpulsed_ARITH_UINT256_H
