...
#ifndef bitpulse_ARITH_UINT256_H
#define bitpulse_ARITH_UINT256_H
...
public:
     ...
     *
     * Bitpulse only uses this "compact" format for encoding difficulty
...
#endif // bitpulse_ARITH_UINT256_H
