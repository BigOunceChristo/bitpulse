...
#ifndef bitpulse_IPC_CAPNP_COMMON_TYPES_H
#define bitpulse_IPC_CAPNP_COMMON_TYPES_H
...
//! Functions to serialize / deserialize common bitpulse types.
namespace mp {
...
#endif // bitpulse_IPC_CAPNP_COMMON_TYPES_H
