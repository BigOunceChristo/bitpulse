...
#ifndef bitpulsed_WALLET_TRANSACTION_H
#define bitpulsed_WALLET_TRANSACTION_H
...
public:
     ...
     * on this bitpulsed node, and set to 0 for transactions that were created
...
#endif // bitpulsed_WALLET_TRANSACTION_H
