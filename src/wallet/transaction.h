...
#ifndef bitpulse_WALLET_TRANSACTION_H
#define bitpulse_WALLET_TRANSACTION_H
...
public:
     ...
     * on this bitpulse node, and set to 0 for transactions that were created
...
#endif // bitpulse_WALLET_TRANSACTION_H
