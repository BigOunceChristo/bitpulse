...
#ifndef bitpulse_WALLET_WALLET_H
#define bitpulse_WALLET_WALLET_H
...
public:
     ...
     * bitpulse-wallet tool code or by wallet migration code. If this is called
...
#endif // bitpulse_WALLET_WALLET_H
