...
#ifndef bitpulsed_WALLET_WALLET_H
#define bitpulsed_WALLET_WALLET_H
...
public:
     ...
     * bitpulsed-wallet tool code or by wallet migration code. If this is called
...
#endif // bitpulsed_WALLET_WALLET_H
