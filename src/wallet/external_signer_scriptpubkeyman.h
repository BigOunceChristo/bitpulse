...
#ifndef bitpulse_WALLET_EXTERNAL_SIGNER_SCRIPTPUBKEYMAN_H
#define bitpulse_WALLET_EXTERNAL_SIGNER_SCRIPTPUBKEYMAN_H
...
#endif // bitpulse_WALLET_EXTERNAL_SIGNER_SCRIPTPUBKEYMAN_H
