...
#ifndef bitpulsed_WALLET_EXTERNAL_SIGNER_SCRIPTPUBKEYMAN_H
#define bitpulsed_WALLET_EXTERNAL_SIGNER_SCRIPTPUBKEYMAN_H
...
#endif // bitpulsed_WALLET_EXTERNAL_SIGNER_SCRIPTPUBKEYMAN_H
