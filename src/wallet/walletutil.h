...
#ifndef bitpulsed_WALLET_WALLETUTIL_H
#define bitpulsed_WALLET_WALLETUTIL_H
...
enum WalletFlags : uint64_t {
    ...
    //! bitpulsed from opening the wallet, thinking it was newly created, and
...
#endif // bitpulsed_WALLET_WALLETUTIL_H
