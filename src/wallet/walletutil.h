...
#ifndef bitpulse_WALLET_WALLETUTIL_H
#define bitpulse_WALLET_WALLETUTIL_H
...
enum WalletFlags : uint64_t {
    ...
    //! bitpulse from opening the wallet, thinking it was newly created, and
...
#endif // bitpulse_WALLET_WALLETUTIL_H
