...
#ifndef bitpulse_INTERFACES_CHAIN_H
#define bitpulse_INTERFACES_CHAIN_H
...
//! internal workings of the bitpulse node, and not being very convenient to use.
...
#endif // bitpulse_INTERFACES_CHAIN_H
