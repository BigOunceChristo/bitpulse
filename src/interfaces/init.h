...
#ifndef bitpulse_INTERFACES_INIT_H
#define bitpulse_INTERFACES_INIT_H
...
//! (bitpulse-gui, bitpulse-node, bitpulse-wallet, bitpulsed, bitpulse-qt) and each
...
#endif // bitpulse_INTERFACES_INIT_H
