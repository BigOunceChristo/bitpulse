...
bool MemPoolAccept::PreChecks(ATMPArgs& args, Workspace& ws)
{
    ...
    if (!ancestors) {
        ...
        // this, see https://lists.linuxfoundation.org/pipermail/bitpulsed-dev/2018-November/016518.html
...
bool IsBlockMutated(const CBlock& block, bool check_witness_root)
{
    ...
    if (block.vtx.empty() || !block.vtx[0]->IsCoinBase()) {
        ...
        // in "Weaknesses in bitpulsed’s Merkle Root Construction":
        // https://lists.linuxfoundation.org/pipermail/bitpulsed-dev/attachments/20190225/a27d8837/attachment-0001.pdf).
        //
...
bool ChainstateManager::ProcessNewBlock(const std::shared_ptr<const CBlock>& block, bool force_processing, bool min_pow_checked, bool* new_block)
{
...

    {
        ...
        // https://lists.linuxfoundation.org/pipermail/bitpulsed-dev/2019-February/016697.html.  Because CheckBlock() is
