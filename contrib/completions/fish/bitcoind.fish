...
complete --command bitpulsed --no-files

# Extract options
function __fish_bitpulsed_get_options
...
complete \
    --command bitpulsed \
    --arguments "(__fish_bitpulsed_get_options --nofiles)"
