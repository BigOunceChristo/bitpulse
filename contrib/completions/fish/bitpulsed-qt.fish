...
complete --command bitpulsed-qt --no-files

# Extract options
function __fish_bitpulsedqt_get_options
...
complete \
    --command bitpulsed-qt \
    --arguments "(__fish_bitpulsedqt_get_options)"
# Enable file completions only if the commandline now contains a `*.=` style option
complete -c bitpulsed-qt \
...
complete \
    --command bitpulsed-qt \
    --arguments "(__fish_bitpulsedqt_get_options --nofiles)"
