...
# Extract options
function __fish_bitpulsed_tx_get_options
...
# Extract commands
function __fish_bitpulsed_tx_get_commands
...
# Add options
complete \
    --command bitpulsed-tx \
    --condition "not __fish_bitpulsed_seen_cmd (__fish_bitpulsed_tx_get_commands --commandsonly)" \
    --arguments "(__fish_bitpulsed_tx_get_options)" \
    --no-files

# Add commands
complete \
    --command bitpulsed-tx \
    --arguments "(__fish_bitpulsed_tx_get_commands)" \
    --no-files
