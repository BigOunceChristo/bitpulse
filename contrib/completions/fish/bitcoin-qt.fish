...
complete --command bitpulse-qt --no-files

# Extract options
function __fish_bitpulseqt_get_options
...
complete \
    --command bitpulse-qt \
    --arguments "(__fish_bitpulseqt_get_options --nofiles)"
