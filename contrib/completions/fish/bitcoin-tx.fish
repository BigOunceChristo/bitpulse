...
# Extract options
function __fish_bitpulse_tx_get_options
...
# Extract commands
function __fish_bitpulse_tx_get_commands
...
complete \
    --command bitpulse-tx \
    --condition "not __fish_bitpulse_seen_cmd (__fish_bitpulse_tx_get_commands --commandsonly)" \
    --arguments "(__fish_bitpulse_tx_get_options)" \
    --no-files

# Add commands
complete \
    --command bitpulse-tx \
    --arguments "(__fish_bitpulse_tx_get_commands)" \
    --no-files
