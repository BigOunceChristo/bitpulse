# Bootstrappable bitpulsed Core Builds

This directory contains the files necessary to perform bootstrappable bitpulsed
Core builds.
...
To build bitpulsed Core reproducibly with all default options, invoke the
...
2. The `guix-codesign` command ***requires*** a `DETACHED_SIGS_REPO` flag.
    * _**DETACHED_SIGS_REPO**_
      ...
      bitpulsed Core version being built.
...
```
env DETACHED_SIGS_REPO=<path/to/bitpulsed-detached-sigs> ./contrib/guix/guix-codesign
```
