# Bootstrappable bitpulse Core Builds

This directory contains the files necessary to perform bootstrappable bitpulse
Core builds.
...
To build bitpulse Core reproducibly with all default options, invoke the
...
2. The `guix-codesign` command ***requires*** a `DETACHED_SIGS_REPO` flag.
    * _**DETACHED_SIGS_REPO**_
      ...
      bitpulse Core version being built.
...
```
env DETACHED_SIGS_REPO=<path/to/bitpulse-detached-sigs> ./contrib/guix/guix-codesign
```
