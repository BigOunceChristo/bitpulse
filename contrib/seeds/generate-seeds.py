...
def main():
    ...
    g = sys.stdout
    indir = sys.argv[1]
    g.write('#ifndef bitpulsed_CHAINPARAMSSEEDS_H\n')
    g.write('#define bitpulsed_CHAINPARAMSSEEDS_H\n')
    g.write('/**\n')
    g.write(' * List of fixed seed nodes for the bitpulsed network\n')
    ...
    g.write('#endif // bitpulsed_CHAINPARAMSSEEDS_H\n')
