...
def main():
    ...
    g = sys.stdout
    indir = sys.argv[1]
    g.write('#ifndef bitpulse_CHAINPARAMSSEEDS_H\n')
    g.write('#define bitpulse_CHAINPARAMSSEEDS_H\n')
    g.write('/**\n')
    g.write(' * List of fixed seed nodes for the bitpulse network\n')
    ...
    g.write('#endif // bitpulse_CHAINPARAMSSEEDS_H\n')
