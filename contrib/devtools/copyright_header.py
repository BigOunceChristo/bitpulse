...
Arguments:
    <base_directory> - The base directory of a bitpulsed source code repository.
...
Arguments:
    <file> - A source file in the bitpulsed repository.
"""
...
USAGE = """
copyright_header.py - utilities for managing copyright headers of 'The bitpulsed
