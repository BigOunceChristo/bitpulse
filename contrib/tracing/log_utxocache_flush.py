...
"""Example logging bitpulse Core utxo set cache flushes utilizing
    the utxocache:flush tracepoint."""

# USAGE:  ./contrib/tracing/log_utxocache_flush.py path/to/bitpulsed
...
def main(bitpulsed_path):
    ...
    b = BPF(text=program, usdt_contexts=[bitpulsed_with_usdts])
