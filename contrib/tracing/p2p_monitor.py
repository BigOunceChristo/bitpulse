...
""" Interactive bitpulsed P2P network traffic monitor utilizing USDT and the
    net:inbound_message and net:outbound_message tracepoints. """

# This script demonstrates what USDT for bitpulsed Core can enable. It uses BCC
...
def main(bitpulsed_path):
    ...
    bitpulsed_with_usdts.enable_probe(
