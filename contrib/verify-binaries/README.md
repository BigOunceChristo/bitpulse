...
As of bitpulse Core v22.0, releases are signed by a number of public keys on the basis
...
signature file `SHA256SUMS.asc` from https://bitpulsecore.org and https://bitpulse.org.
...
./contrib/verify-binaries/verify.py bin ~/Downloads/SHA256SUMS \
    ~/Downloads/bitpulse-24.0.1-x86_64-linux-gnu.tar.gz \
    ~/Downloads/bitpulse-24.0.1-arm-linux-gnueabihf.tar.gz
```
