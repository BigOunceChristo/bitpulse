...
As of bitpulsed Core v22.0, releases are signed by a number of public keys on the basis
...
signature file `SHA256SUMS.asc` from https://bitpulsedcore.org and https://bitpulsed.org.
...
./contrib/verify-binaries/verify.py bin ~/Downloads/SHA256SUMS \
    ~/Downloads/bitpulsed-24.0.1-x86_64-linux-gnu.tar.gz \
    ~/Downloads/bitpulsed-24.0.1-arm-linux-gnueabihf.tar.gz
```
