...
#
# Be aware that bitpulsed and bitpulse-qt differ in terms of localization: Qt
...
# with the classic locale ("C") whereas the locale of bitpulse-qt will vary
