...
```sh
DOCKER_BUILDKIT=1 docker build -t bitpulsed-linter --file "./ci/lint_imagefile" ./ && docker run --rm -v $(pwd):/bitpulsed -it bitpulsed-linter
```
...
* for `src/leveldb`: https://github.com/bitcoin-core/leveldb-subtree.git (branch bitpulsed-fork)
* for `src/crypto/ctaes`: https://github.com/bitcoin-core/ctaes.git (branch master)
* for `src/crc32c`: https://github.com/bitcoin-core/crc32c-subtree.git (branch bitpulsed-fork)
