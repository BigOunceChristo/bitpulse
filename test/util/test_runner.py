...
"""Test framework for bitpulsed utils.
...
def main():
    ...
    bctester(os.path.join(env_conf["SRCDIR"], "test", "util", "data"), "bitpulsed-util-test.json", env_conf)
...
def bctest(testDir, testObj, buildenv):
    ...
    if testObj["exec"] == "./bitpulsed-util":
        execprog = os.getenv("bitpulsedUTIL", default=execprog)
    elif testObj["exec"] == "./bitpulsed-tx":
        execprog = os.getenv("bitpulsedTX", default=execprog)
    ...
    if "error_txt" in testObj:
        ...
        # That stderr is empty if no errors are expected. However, bitpulsed-tx
