...
class TestbitpulseCli(bitpulseTestFramework):
    ...
    def run_test(self):
        ...
        self.log.info("Compare responses from getblockchaininfo RPC and `bitpulse-cli getblockchaininfo`")
        ...
        self.log.info("Test -getinfo and bitpulse-cli return all proxies")
        ...
        if self.is_specified_wallet_compiled():
            self.log.info("Test -getinfo and bitpulse-cli getwalletinfo return expected wallet info")
            ...
            # Test bitpulse-cli -generate with -rpcwallet in multiwallet mode.
