...
class SettingsTest(bitpulseTestFramework):
    ...
    def run_test(self):
        ...
        conf = node.datadir_path / "bitpulse.conf"

        # Assert default settings file was created
        self.stop_node(0)
        default_settings = {"_warning_": "This file is automatically generated and updated by bitpulse Core. Please do not edit this file while the node is running, as any changes might be ignored or overwritten."}
