...
"""
Test starting bitpulsed with -bind and/or -bind=...=onion and confirm
...
class BindExtraTest(bitpulsedTestFramework):
    ...
    def run_test(self):
        for i in range(len(self.expected)):
            ...
            # that bitpulsed has bound on "::1" (for RPC) and "::" (for P2P).
