...
Verify that a bitpulsed node can use an external signer command.
...
class RPCSignerTest(bitpulsedTestFramework):
    ...
    def run_test(self):
        ...
        assert_raises_rpc_error(-1, 'Error: restart bitpulsed with -signer=<cmd>',
