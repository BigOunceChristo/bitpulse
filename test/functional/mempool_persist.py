...
By default, bitpulsed will dump mempool on shutdown and
...
class MempoolPersistTest(bitpulsedTestFramework):
    ...
    def run_test(self):
        ...
        self.log.debug("Prevent bitpulsed from writing mempool.dat to disk. Verify that `savemempool` fails")
