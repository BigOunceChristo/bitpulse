...
class TestShell:
    """Wrapper Class for bitpulseTestFramework.

    The TestShell class extends the bitpulseTestFramework
    ...
    class __TestShell(bitpulseTestFramework):
        ...
        def setup(self, **kwargs):
            ...
            # by bitpulseTestFramework child class.
            self.num_nodes = 1
