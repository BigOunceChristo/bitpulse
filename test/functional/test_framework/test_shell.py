...
class TestShell:
    """Wrapper Class for bitpulsedTestFramework.

    The TestShell class extends the bitpulsedTestFramework
    ...
    class __TestShell(bitpulsedTestFramework):
        ...
        def setup(self, **kwargs):
            ...
            # by bitpulsedTestFramework child class.
            self.num_nodes = 1
