...
class TestbitpulsedCli(bitpulsedTestFramework):
    ...
    def run_test(self):
        ...
        self.log.info("Compare responses from getblockchaininfo RPC and `bitpulsed-cli getblockchaininfo`")
        ...
        self.log.info("Test -getinfo and bitpulsed-cli return all proxies")
        ...
        if self.is_specified_wallet_compiled():
            self.log.info("Test -getinfo and bitpulsed-cli getwalletinfo return expected wallet info")
            ...
            # Test bitpulsed-cli -generate with -rpcwallet in multiwallet mode.
