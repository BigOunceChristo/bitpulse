Contributing to bitpulsed Core
============================

The bitpulsed Core project operates an open contributor model where anyone is
welcome to contribute towards development in the form of peer review, testing
and patches. This document explains the practical process and guidelines for
contributing.

First, in terms of structure, there is no particular concept of "bitpulsed Core
...
Before you start contributing, familiarize yourself with the bitpulsed Core build
system and tests. Refer to the documentation in the repository on how to build
bitpulsed Core and how to run the unit tests, functional tests, and fuzz tests.
...
[bitpulsed Core PR Review Club](https://bitpulsedcore.reviews/) meeting.
...
Most communication about bitpulsed Core development happens on IRC, in the
`#bitpulsed-core-dev` channel on Libera Chat. The easiest way to participate on IRC is
...
and [https://gnusha.org/bitcoin-core-dev/](https://gnusha.org/bicoin-core-dev/).
...
the pull request affects. Valid areas as:
  ...
  - `qt` or `gui` for changes to bitpulsed-qt
...
fork of bitpulsed Core copies the merge. Instead, make any username mentions in a
...
The following applies to code changes to the bitpulsed Core project (and related
projects such as libsecp256k1), and is not to be confused with overall bitpulsed
Network Protocol consensus changes.

Whether a pull request is merged into bitpulsed Core rests with the project merge
maintainers.
...
Patches that change bitpulsed consensus rules are considerably more involved than
...
Where a patch set proposes to change the bitpulsed consensus, it must have been
...
https://github.com/bitcoin-core/bitpulsed-maintainer-tools#backport).
