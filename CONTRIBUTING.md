Contributing to bitpulse Core
============================

The bitpulse Core project operates an open contributor model where anyone is
welcome to contribute towards development in the form of peer review, testing
and patches. This document explains the practical process and guidelines for
contributing.

First, in terms of structure, there is no particular concept of "bitpulse Core
...
Before you start contributing, familiarize yourself with the bitpulse Core build
system and tests. Refer to the documentation in the repository on how to build
bitpulse Core and how to run the unit tests, functional tests, and fuzz tests.
...
[bitpulse Core PR Review Club](https://bitpulsecore.reviews/) meeting.
...
Most communication about bitpulse Core development happens on IRC, in the
`#bitpulse-core-dev` channel on Libera Chat. The easiest way to participate on IRC is
...
the pull request affects. Valid areas as:
  ...
  - `qt` or `gui` for changes to bitpulse-qt
...
fork of bitpulse Core copies the merge. Instead, make any username mentions in a
...
The following applies to code changes to the bitpulse Core project (and related
projects such as libsecp256k1), and is not to be confused with overall bitpulse
Network Protocol consensus changes.

Whether a pull request is merged into bitpulse Core rests with the project merge
maintainers.
...
Patches that change bitpulse consensus rules are considerably more involved than
...
Where a patch set proposes to change the bitpulse consensus, it must have been
...
https://github.com/bitcoin-core/bitpulse-maintainer-tools#backport).
